...
export function ReportIssueButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 bg-gray-800 hover:bg-gray-700 text-white px-4 py-3 rounded-full shadow-lg transition-all duration-200 hover:scale-105 z-50 flex items-center gap-3"
